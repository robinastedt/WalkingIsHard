...
public class Config {
    ...
    public static final double MUTATION_REMOVE_GENE = 0.03;
    public static final double MUTATION_ADD_GENE = 0.03;
    ...
    public static final int RANDOM_GENOME_ADD_JOINT_RATIO = 3;
    public static final int RANDOM_GENOME_NOT_ADD_MUSCLE_RATIO = 3;
